...
def compute_data_metrics(batch, use_critic=True):
    ...
    for key, value in {
        ...
        'critic/memory_scores': batch.batch['memory_scores'],
        'critic/query_length': batch.batch['query_length'],
            ...
            for batch_dict in self.train_dataloader:
                ...
                # with _timer('step', timing_raw):
                    ...
                    with _timer('adv', timing_raw):
                        ...
                        reward_tensor = self.reward_fn(batch, self.global_steps , self.total_training_steps)
